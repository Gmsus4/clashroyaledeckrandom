...
const espirituSanador = new Cards('Espíritu Sanador','https://cdn.statsroyale.com/images/cards/full/healspirit.png');
...
//Hechizo
const bolaDeFuego = new Cards('Bola De Fuego','https://cdn.statsroyale.com/images/cards/full/fire_fireball.png');
const flechas = new Cards('Flechas','https://cdn.statsroyale.com/images/cards/full/order_volley.png');
const furia = new Cards('Furia','https://cdn.statsroyale.com/images/cards/full/rage.png');
const cohete = new Cards('Cohete','https://cdn.statsroyale.com/images/cards/full/rocket.png');
const barrilDeDuendes = new Cards('Barril De Duendes','https://cdn.statsroyale.com/images/cards/full/goblin_barrel.png');
const hielo = new Cards('Hielo','https://cdn.statsroyale.com/images/cards/full/freeze.png');
const espejo = new Cards('Espejo','https://cdn.statsroyale.com/images/cards/full/mirror.png');
const rayo = new Cards('Rayo','https://cdn.statsroyale.com/images/cards/full/lightning.png');
const descarga = new Cards('Descarga','https://cdn.statsroyale.com/images/cards/full/zap.png');
const veneno = new Cards('Veneno','https://cdn.statsroyale.com/images/cards/full/poison.png');
const cementerio = new Cards('Cementerio','https://cdn.statsroyale.com/images/cards/full/graveyard.png');
const elTronco = new Cards('El Tronco','https://cdn.statsroyale.com/images/cards/full/the_log.png');
const tornado = new Cards('Tornado','https://cdn.statsroyale.com/images/cards/full/tornado.png');
const clon = new Cards('Clon','https://cdn.statsroyale.com/images/cards/full/copy.png');
const terremoto = new Cards('Terremoto','https://cdn.statsroyale.com/images/cards/full/earthquake.png');
const barrilDeBarbaro= new Cards('Barril De Bárbaro','https://cdn.statsroyale.com/images/cards/full/barb_barrel.png');
const bolaDeNieve = new Cards('Bola De Nieve','https://cdn.statsroyale.com/images/cards/full/snowball.png');
const paqueteReal = new Cards('Paquete Real','https://cdn.statsroyale.com/images/cards/full/royal_delivery.png');
